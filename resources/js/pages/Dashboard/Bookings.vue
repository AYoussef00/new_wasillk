  ...
  <AuthenticatedLayout>
    ...
    <div class="py-12">
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <!-- Success Message -->
        <div v-if="props.success" class="mb-6 bg-green-50 border border-green-200 rounded-lg p-4">
        ...
        <!-- Error Message -->
        <div v-if="props.error" class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
          <div class="flex items-center">
            <div class="flex-shrink-0">
        ...
        <!-- Header -->
        <div class="mb-6">
          <h3 class="text-lg font-semibold text-gray-900">إدارة الطلبات</h3>
          <p class="text-sm text-gray-600">إدارة وتتبع جميع طلبات الحجز</p>
           ...
           <div class="mt-4 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
              <div class="flex items-center">
                ...
                <div class="mr-3">
                  <p class="text-sm font-medium text-yellow-800">الحجوزات المعلقة</p>
            ...
            <div class="bg-green-50 border border-green-200 rounded-lg p-4">
              <div class="flex items-center">
                ...
                <div class="mr-3">
                  <p class="text-sm font-medium text-green-800">الحجوزات المؤكدة</p>
               ...
               <div class="flex items-center">
                 ...
                 <div class="mr-3">
                   <p class="text-sm font-medium text-red-800">الحجوزات المرفوضة</p>
             ...
             <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
               <div class="flex items-center">
                 ...
                 <div class="mr-3">
                   <p class="text-sm font-medium text-blue-800">إجمالي الحجوزات</p>
              ...
              <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                  <tr v-for="booking in filteredBookings" :key="booking.id" class="hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900">{{ booking.pickup_date }}</div>
                      <div class="text-sm text-gray-500">إلى {{ booking.return_date }}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div class="flex space-x-2 space-x-reverse">
                        <button class="inline-flex items-center px-2 py-1 text-xs font-medium text-blue-700 bg-blue-100 rounded-md hover:bg-blue-200 transition-colors duration-200">
